...
require_once 'test/helper/public.php';

class periodicFunctionalExecutorTests extends periodicBaseTest
{
    ...
    {
        parent::setUp();
        $this->taskFactory = new periodicTaskFactory( dirname( __FILE__ ) . '/../data/tasks/', new periodicCommandRegistry() );
    }
